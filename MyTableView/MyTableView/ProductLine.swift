...
class ProductLine
{
    ...
    private class func iDevices() -> ProductLine {
        ...
        products.append(Product(titled: "iPad", description: "iPad Air 2 is the thinnest and most powerful iPad ever. With iPad, we’ve always had a somewhat paradoxical goal: to create a device that’s immensely powerful, yet so thin and light you almost forget it’s there.", imageName: "ipad-air2.tif"))
